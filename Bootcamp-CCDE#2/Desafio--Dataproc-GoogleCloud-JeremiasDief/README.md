 ...
 - Abrir o Cloud Shell;
    - No Cloud Shell:
        ...
        - Copiar os arquivos ```contador.py``` e ```livro.txt``` para o meu Bucket;
         ...
         <p align="center"><img src="./Tela comandos Cloud Shell.png" width="500"></p>

        - Minimizar o Cloud Shell;
 - Criar um novo Job, tipo PySpark, passando o arquivo ```contador.py``` para rodar o contador de palavras no ```livro.txt``` (meu job: job-desafio-jdief);

 <p align="center"><img src="./Tela criando o job.png" width="800"></p>
...
### __*Os dois arquivos resultantes (```part-00000``` e ```resultado.txt```) se encontram dentro da pasta ```resultado``` deste repositório.*__
